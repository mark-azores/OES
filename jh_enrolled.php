...
<script>
    ...
    $(function () {
        ...
        $('#grade_level').change(function(){
            ...
            var grade_level = this.value;
            var btn_action = 'admission_section';
            $.ajax({
                url:"action.php",
                method:"POST",
                data:{grade_level:grade_level, btn_action:btn_action},
                dataType:"json",
                success:function(data)
                {
        ...
        //     if (question == 'Undo' || question == 'Complete')
        //     {
        //         $('#paymentModal').modal('show');
        //     }
        // });
        ...
        $("#grade_levels").change(function(){
            ...
            dataTable = $("#datatables").DataTable({
                ...
                "order":[],
                "ajax":{
                    url:"fetch/jh_enrolled.php?grade_level="+$("#grade_levels").val(),
                    type:"POST"
                },
                "columnDefs":[
                    {
