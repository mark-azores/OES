                                ...
                                <div class="row">  
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-12 col-md-2">
                                                ...
                                                <div class="input-group date" id="date_births" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input" data-target="#date_births" name="date_birth" id="date_birth" required placeholder="MM/DD/YY"/>
                                            ...
                                            <div class="form-group col-12 col-md-3">
                                                ...
                                                <input type="number" min="1" name="contact" id="contact" class="form-control no-spinners" maxlength = "11" 
                                            ...
                                            <div class="form-group col-12 col-md-4">
                                                <span>House Number/ Block & Lot <span class="text-danger">*</span></span>
                                                <input name="house" id="house" class="form-control" placeholder="" required />
                                            </div>
                                            <div class="form-group col-12 col-md-4">
                                                <span>Street Name <span class="text-danger">*</span></span>
                                                <input name="street" id="street" class="form-control" placeholder="" required />
                                            </div>
                                            <div class="form-group col-12 col-md-4">
                                                <span>Barangay<span class="text-danger">*</span></span>
                                                <input name="barangay" id="barangay" class="form-control" placeholder="" required />
                                            </div>
                                            <div class="form-group col-12 col-md-4">
                                                <span>City/ Municipality <span class="text-danger">*</span></span>
                                                <input name="city" id="city" class="form-control" placeholder="" required />
                                            </div>
                                            <div class="form-group col-12 col-md-4">
                                                <span>Province<span class="text-danger">*</span></span>
                                                <input name="province" id="province" class="form-control" placeholder="" required />
                                            </div>
                                            <div class="form-group col-12 col-md-4">
                                                <span>ZIP Code<span class="text-danger">*</span></span>
                                                <input name="zip" id="zip" class="form-control" placeholder="" required />
                                            </div>
                                            <div class="form-group col-12 col-md-12">
                                                <hr class="p-0 m-0">
                                            ...
                                            <div class="form-group col-12 col-md-12">
                                                <span>How do you know Lake Shore? <span class="text-danger">*</span></span>
                                    ...
                                    <div class="col-12 page_two hidden">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-12 col-md-3">
                                                <span>Contact Number<span class="text-danger">*</span></span>
                                                <input type="number" min="1" name="g_contact" id="g_contact" class="form-control no-spinners" maxlength = "11" 
