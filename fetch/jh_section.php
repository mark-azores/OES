...
$query .= "SELECT * FROM $JHSECTION_TABLE WHERE  ";
...
foreach($result as $row)
{
	...
	<a class="btn btn-success view elevation-2 pr-3 pl-3" href="#" name="view" 
		id="'.$row["id"].'" data-grade_level="'.$row["grade_level"].'" data-section="'.$row["section"].'" data-adviser="'.$adviser.'" 
...
$output = array(
	...
	"recordsFiltered" 	=> 	get_total_all_records($connect, $JHSECTION_TABLE),
	"data"				=>	$data
);
