...
try {
    ...
    $USER_COLUMN = 'fullname, user_name, password, contact, user_email, address, user_type, status, date_created';
    session_start();
    ...
    if ($statement->rowCount() == 0) {
        $create = "CREATE TABLE $INSTRUCTOR_TABLE(
                ...
                `strand_id` VARCHAR(20) DEFAULT NULL,
    ...
    if ($statement->rowCount() == 0) {
        $create = "CREATE TABLE $JHSECTION_TABLE(
                ...
                `grade_lowest` VARCHAR(5) DEFAULT NULL,
                `grade_highest` VARCHAR(5) DEFAULT NULL,
                `no_limit` VARCHAR(10) DEFAULT NULL,
                `no_students` VARCHAR(10) DEFAULT NULL,
                `status` VARCHAR(10) DEFAULT NULL,
                `date_created` VARCHAR(10) DEFAULT NULL,
                INDEX (`id`)
            );";
    ...
    if ($statement->rowCount() == 0) {
        $create = "CREATE TABLE $ADMISSION_TABLE(
                ...
                `last_attended` VARCHAR(50) DEFAULT NULL,
                ...
                `assessment_status` VARCHAR(30) DEFAULT NULL,
                `button_status` VARCHAR(30) DEFAULT NULL,
                `date_enrolled` VARCHAR(10) DEFAULT NULL,
                `date_created` VARCHAR(10) DEFAULT NULL,
                `time_created` VARCHAR(10) DEFAULT NULL,
                `report_card1` VARCHAR(55) DEFAULT NULL,
                `report_card_date` VARCHAR(55) DEFAULT NULL,
                `psa` VARCHAR(55) DEFAULT NULL,
                `psa_date` VARCHAR(55) DEFAULT NULL,
                `form_1371` VARCHAR(55) DEFAULT NULL,
                `form_137_date` VARCHAR(55) DEFAULT NULL,
                `good_moral` VARCHAR(55) DEFAULT NULL,
                `good_moral_date` VARCHAR(55) DEFAULT NULL,
                `certificate` VARCHAR(55) DEFAULT NULL,
                `certificate_date` VARCHAR(55) DEFAULT NULL,
