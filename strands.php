                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-12 col-md-12">
                            <input type="text" name="strand" id="strand" class="form-control" placeholder="Strand" required />
                        </div>
                    </div>
                </div>
...
<script>
    $(function () {
        ...
        $('#add_button').click(function(){
            ...
            $('#action').val('strand_add');
            $('#btn_action').val('strand_add');
        });
        ...
        $(document).on('click', '.update', function(){
            ...
            $.ajax({
                ...
                success:function(data)
                {
                    ...
                    $('#action').val('strand_update');
                    $('#btn_action').val('strand_update');
                },error:function()
                {
                    Toast.fire({
                        icon: 'error',
