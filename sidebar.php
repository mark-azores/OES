                            ...
                            ? 'menu-open' : '' ?>">
                                ...
                                Applicants
                                    <span class="badge badge-success">
                                        ...
                                        echo get_total_count($connect, "SELECT * FROM $ADMISSION_TABLE 
                                        WHERE school_year = '".$sy["school_year"]."' AND status IN ('Scheduled','Pending') AND archived IS NULL AND grade_level BETWEEN 11 AND 12  "); ?>
                                    </span>
                                    <i class="right fas fa-angle-left"></i>
                                </p>
                            </a>
                            ...
                            ? 'menu-open' : '' ?>">
                                ...
                                <p> Applicants 
                                    <span class="badge badge-success">
                                        ...
                                        $sy = fetch_row($connect, "SELECT * FROM $SY_TABLE WHERE status = 'Active' ");
                                        echo get_total_count($connect, "SELECT * FROM $ADMISSION_TABLE 
                                        WHERE school_year = '".$sy["school_year"]."' AND status IN ('Scheduled','Pending') AND archived IS NULL AND grade_level BETWEEN 7 AND 10  "); ?>
                                    </span>
                                    <i class="right fas fa-angle-left"></i>
                                </p>
                            </a>
